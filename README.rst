...
+====================+================================================+=======+=============+=========+
| `cardano-wallet`_  | JSON/REST API for managing UTxOs in HD wallets | ✅     | ✅           | ⛏       |
+--------------------+------------------------------------------------+-------+-------------+---------+
| `cardano-rest`_    | JSON/HTTP API for browsing on-chain data       | ✅     | ⛔           | ⛏       |
+--------------------+------------------------------------------------+-------+-------------+---------+
| `cardano-graphql`_ | GraphQL/HTTP API for browsing on-chain data    | ✅     | ⛔           | ⛏       |
+--------------------+------------------------------------------------+-------+-------------+---------+
